...
interface NavbarProps {
  logoUrl?: string;
  menuItems?: Array<{ name: string; url: string; active?: boolean }>;
}
...
const Navbar: React.FC<NavbarProps> = ({
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (event: MouseEvent) => {
      ...
      const button = document.getElementById("dropdown-avatar-button");
    ...
    <div className=" ">
      <nav className="relative px-4 py-4 flex justify-between items-center text-primary">
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
          ...
          <li className="text-primary opacity-50">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              stroke="currentColor"
          ...
          <li>
            <LanguageSwitcher className="text-white hover:text-white hover:bg-primary" />
          </li>
        </ul>
            ...
            <div className="dropdown relative inline-block">
              ...
              >
                <div className="avatar">
                  <div className="size-11.5 rounded-full">
                    <img
              ...
              <ul
                ...
                className={`absolute right-0 z-10 mt-2 min-w-60 rounded-md bg-background shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ${
              ...
              >
                <li className="flex items-center gap-2 px-4 py-3 border-b border-primary">
                  <div className="avatar">
                    <div className="size-11.5 rounded-full">
                      <img
                        className="rounded-full"
                  ...
                  <div>
                    ...
                    <div className="flex items-center justify-between w-5/4">
                      <small className="text-gray-500">Admin</small>
                      <small className="text-gray-500">|</small>
                      <small className="text-gray-500">NumberPoint</small>
                    </div>
                  </div>
                </li>
                <li>
                  <a
                    ...
                    href="#"
                  >
                    <span className="icon-[tabler--user] mr-2"></span>
                    My Profile
                  </a>
                </li>
                <li>
                  <a
                    ...
                    href="#"
                  >
                    <span className="icon-[tabler--settings] mr-2"></span>
                    Settings
                  </a>
                </li>
                <li className="border-t border-gray-100 mt-1">
                  <a
                    className="block px-4 py-2 text-sm text-red-600 hover:bg-accent"
                    href="#"
                    onClick={testFunction}
                  >
                    <span className="icon-[tabler--logout] mr-2"></span>
                    Sign out
                  </a>
                </li>
              </ul>
      ...
      >
        <div
          className="navbar-backdrop fixed inset-0 bg-background opacity-50"
          onClick={toggleMenu}
        ></div>
        <nav className="fixed top-0 left-0 bottom-25 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-background border-r overflow-y-auto">
          <div className="flex items-center mb-8">
            ...
            >
              <svg
                className="h-6 w-6 text-primary cursor-pointer hover:text-secondary"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
          ...
          <div>
            <ul>
              ...
              <li className="p-2 block">
                <LanguageSwitcher className="text-primary hover:text-white hover:bg-primary" />
              </li>
            </ul>
          </div>
          ...
          <div className="mt-auto">
            <div className="pt-6">
              {!isConnected ? (
                ...
                <div className="px-4 py-3 mb-2">
                  ...
                  <a
                    className="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 text-center rounded-xl border border-red-200"
                    href="#"
                    onClick={testFunction}
                  >
                    <span className="icon-[tabler--logout] mr-2"></span>
            ...
            <p className="my-4 text-xs text-center text-primary opacity-70">
